...
function buildLeaderboard(newTrades=[]) {
  ...
  return Object.values(merged).sort((a,b)=>b.trades-a.trades).map((row,i)=>({...row,rank:i+1,badge:i===0?"
}
        ...
        <div style={{display:"flex",alignItems:"flex-start",justifyContent:"space-between",gap:16,flexWrap:"wrap"}}>
          <div style={{flex:1,minWidth:0}}>
            ...
            <div style={{display:"flex",gap:6,marginBottom:10,flexWrap:"wrap"}}>
              ...
              {winner===true&&!alreadyClaimed&&<span style={{fontSize:10,fontWeight:700,color:t.green,background:t.greenBg,padding:"3px 8px",borderRadius:4,fontFamily:"monospace"}}>
              {winner===false&&<span style={{fontSize:10,fontWeight:700,color:t.red,background:t.redBg,padding:"3px 8px",borderRadius:4,fontFamily:"monospace"}}>
              {alreadyClaimed&&<span style={{fontSize:10,fontWeight:700,color:t.green,background:t.greenBg,padding:"3px 8px",borderRadius:4,fontFamily:"monospace"}}>
            </div>
            ...
            {d?.market&&(
              <div style={{fontSize:11,fontFamily:"monospace",color:t.textLight}}>
                Pool: YES ${d.market.yesPool.toFixed(2)} · NO ${d.market.noPool.toFixed(2)} ·
          ...
          <div style={{display:"flex",flexDirection:"column",gap:8,alignItems:"flex-end",flexShrink:0}}>
            ...
            {alreadyClaimed&&(
              <a href={`https://testnet.arcscan.app/tx/${alreadyClaimed}`} target="_blank" rel="noreferrer"
                style={{fontSize:11,color:t.blue,fontFamily:"monospace",textDecoration:"none"}}>
            )}
            {status==="open"&&(
        ...
        {allActivity.map((row,i)=>(
          <div key={i} style={{display:"flex",alignItems:"center",gap:10,padding:"12px 20px",borderBottom:i<allActivity.length-1?`1px solid ${t.border}`:"none",background:account&&row.from?.toLowerCase()===account?.toLowerCase()?t.blueDim:"transparent"}}>
            ...
            <a href={`https://testnet.arcscan.app/tx/${row.txHash}`} target="_blank" rel="noreferrer"
              style={{fontSize:10,color:t.blue,fontFamily:"monospace",textDecoration:"none",flexShrink:0}}>
          </div>
        ))}
      </div>
    </div>
      ...
      <div style={{padding:"15px 17px",flex:1,display:"flex",flexDirection:"column",gap:10}}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start"}}>
          ...
          <div style={{display:"flex",gap:4,flexWrap:"wrap",justifyContent:"flex-end"}}>
            {isResolved&&<span style={{fontSize:9,fontWeight:700,color:resolvedOutcome?t.green:t.red,background:resolvedOutcome?t.greenBg:t.redBg,padding:"2px 6px",borderRadius:4,fontFamily:"monospace"}}>{resolvedOutcome?"
            ...
            {!isResolved&&!isCancelled&&m.hot&&<span style={{fontSize:9,fontWeight:700,color:t.amber,background:t.amberBg,padding:"2px 5px",borderRadius:4}}>
            {!isResolved&&!isCancelled&&m.trending&&<span style={{fontSize:9,fontWeight:700,color:t.green,background:t.greenBg,padding:"2px 5px",borderRadius:4}}>
          </div>
        </div>
        ...
        <div style={{padding:"20px"}}>
          {isMarketEnded?(
            ...
            <div style={{textAlign:"center",padding:"8px 0"}}>
              <div style={{width:54,height:54,borderRadius:"50%",background:t.greenBg,border:`2px solid ${t.greenBorder}`,display:"flex",alignItems:"center",justifyContent:"center",margin:"0 auto 16px",fontSize:24}}>
              ...
              <a href={`https://testnet.arcscan.app/tx/${txHash}`} target="_blank" rel="noreferrer"
                style={{display:"block",textAlign:"center",fontSize:12,color:t.blue,fontFamily:"monospace",textDecoration:"none",marginBottom:12}}>
            ...
            <>
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:16}}>
                ...
                <button onClick={onClose} style={{background:"none",border:"none",color:t.textMuted,fontSize:20,cursor:"pointer",lineHeight:1}}>
              </div>
              ...
              {!account&&<div style={{background:t.amberBg,border:`1px solid ${t.amber}`,borderRadius:8,padding:"8px 12px",marginBottom:12,fontSize:12,color:t.amber,fontFamily:"monospace"}}>
              ...
              {loading&&<div style={{background:t.blueDim,border:`1px solid ${t.blueBorder}`,borderRadius:8,padding:"8px 12px",marginBottom:12,fontSize:12,color:t.blue,fontFamily:"monospace"}}>
              ...
              <p style={{textAlign:"center",fontSize:11,color:t.textLight,fontFamily:"monospace",marginTop:10}}>Trades settle on Arc Testnet 
            </>
          )}
        </div>
      </div>
...
◈ {account.slice(0,6)}...{account.slice(-4)} ✕
      ...
      <div style={{background:t.tickerBg,padding:"7px 20px"}}>
        <div style={{maxWidth:1380,margin:"0 auto",display:"flex",alignItems:"center",gap:20,overflowX:"auto"}}>
          ...
          <span style={{fontSize:10,fontFamily:"monospace",color:"rgba(255,255,255,0.4)",margin:"0 4px"}}>
            ...
            <div style={{padding:"44px 0 32px",display:"flex",justifyContent:"space-between",alignItems:"flex-start",gap:32,flexWrap:"wrap"}}>
              <div style={{flex:1,minWidth:280}}>
                <div style={{display:"inline-flex",alignItems:"center",gap:6,background:t.blueDim,border:`1px solid ${t.blueBorder}`,borderRadius:6,padding:"4px 10px",marginBottom:16}}>
                  <span style={{fontSize:10,fontWeight:700,fontFamily:"monospace",letterSpacing:1}}><span style={{color:t.green}}>
                </div>
      ...
      <footer style={{borderTop:`1px solid ${t.border}`,padding:20,textAlign:"center",background:t.bg}}>
        <p style={{fontSize:11,fontFamily:"monospace",color:t.textLight}}>✦ ARCANA.MARKETS · ARC TESTNET 
      </footer>
      {active&&(
        <TradeModal
          m={active}
